(function(){
  var cwbspec, fetch, fetch_rain, parse_rain, fetch_forecast_by_town, get_frames, parse_area, parse_forecast_72hr, slice$ = [].slice;
  ...
  parse_typhoon = curry$(function(data, cb){
    var $, res, i$, ref$, len$, x, $$, name, ref1$, current, forecast, date, lat, lon, lines, f, j$, len1$, line, matched;
    $ = require('cheerio').load(data);
    res = [];
